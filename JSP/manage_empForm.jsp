          ...
          <div class="row">
            <div class="col-md-6" style="margin:auto;">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="${path}/main.do?method=insEmp" method="post" onsubmit="return checkForm();">
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">패스워드</label>
                    ...
                    <div class="row"> -->
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">패스워드 확인</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="civilno" id="civilno" />
                        </div>
                      </div>
                    <!-- </div>
                    <div class="row"> -->
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="posi" id="posi" value="사원" />
                        </div>
                      </div>
                    <!-- </div>
                    <div class="row"> -->
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="sal" id="sal" value="2000" />
                        </div>
                      </div>
                    </div>
                    <div align="center">
