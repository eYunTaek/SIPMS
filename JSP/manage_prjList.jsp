                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <thead class=" text-primary">
                      	<tr>
                      	  <th>팀</th><th>프로젝트명</th><th>업체명</th><th>파견지역</th><th>시작일</th><th>마감일</th>
                      	  <th>단가</th><th>진행단계</th><th>전체단계</th><th>완료</th><th>상세조회</th>
                      	</tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>${prj.comple}</td>
                          <td class="td-actions">
                          	<button type="button" rel="tooltip" title="상세조회" class="btn btn-primary btn-link btn-sm" onclick="detail(${prj.pjno});">
  ...
  <script>
    ...
    $(document).ready(function() {
    	...
    	$("#regBtn").click(function(){
    		$(location).attr("href", "${path}/prj.do?method=prjForm");
    	});
