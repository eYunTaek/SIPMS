                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <col width="10%"/><col width="90%"/>
                      	<tr>
                      	  <th>메세지  번호</th><td>${msg.mno }</td>
                      	</tr>
                      	<tr>
                      	  <th>보낸 사원명</th><td>${msg.ename }</td>
                      	</tr>
                      	<tr>
                      	  <th>직책</th><td>${msg.posi }</td>
                      	</tr>
                      	<tr>
                      	  <th>제목</th><td>${msg.title }</td>
                      	</tr>
                      	<tr>
                      	  <th>내용</th><td><textarea rows="10" class="form-control" readOnly>${msg.content }</textarea></td>
                      	</tr>
                      	<tr>
                      	  <th>수신 여부</th><td>${msg.revstatus }</td>
                      	</tr>
                      	<tr>
                      	  <th>보낸 날짜</th><td><fmt:formatDate value="${msg.sdte }"/></td>
                      	</tr>
                      	<tr><td colspan="2"><input type="button" id="backBtn" class="btn btn-primary" value="초기"/></td></tr>
                      </thead>
                    </table>
                  </div>
                </div>
