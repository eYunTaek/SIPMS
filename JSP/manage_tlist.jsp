...
<body class="">
            ...
            <div class="col-md-8" style="margin:auto;">
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>${t.tno}</td>
                          <td class="td-actions">
                          	<button type="button" rel="tooltip" title="팀원 추가" class="btn btn-primary btn-link btn-sm" onclick="addMem(${t.tno})">
                              <i class="material-icons">add_circle_outline</i>
                          	</button>
                          </td>
                          <td class="td-actions">
                          	<button type="button" rel="tooltip" title="팀 삭제" class="btn btn-primary btn-link btn-sm" onclick="delTeam(${t.tno})">
                  ...
                  <div align="center">
                  	<form action="${path}/team.do?method=crtTeam" method="post">
                  		팀 입력 : <input type="number" name="tno" id="tno" />
	                  	<input type="submit" class="btn btn-primary" value="팀 생성" />
                  	</form>
                  </div>
                </div>
              </div>
  ...
  <script>
	function addMem(tno){
		$(location).attr("href", "${path}/main.do?method=memList2&tno="+tno);
	}
	function delTeam(tno){
		if(confirm("팀을 삭제하시겠습니까?")){
			$(location).attr("href", "${path}/team.do?method=delTeam&tno="+tno);
		}
	}
