...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">팀원 리스트</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">팀원 목록</h4>
                  <p class="card-category">속한 팀원목록을 보여줍니다</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <col width="16%"><col width="14%"><col width="14%"><col width="14%"><col width="14%"><col width="14%"><col width="14%">
                      <thead class=" text-primary">
                      	<tr>
                      	  <th>사원번호</th><th>이름</th><th>직책</th><th>급여</th><th>프로젝트</th><th>업무 관리</th><th>업무 목록</th>
                      	</tr>
                      </thead>
                      <tbody>
                      	<c:forEach var="emp" items="${tmlist}">
                        <tr>
                          <td>${emp.empno}</td>
                          <td>${emp.ename}</td>
                          <td>${emp.position}</td>
                          ...
                          <td>${emp.pjdo}</td>
                           <td class="td-actions">
                          	<button type="button" rel="tooltip" title="업무 부여" class="btn btn-primary btn-link btn-sm" onclick="detail(${emp.empno});">
                              <i class="material-icons">add_circle_outline</i>
                          	</button>
                          </td>
                           <td class="td-actions">
                          	<button type="button" rel="tooltip" title="업무 목록" class="btn btn-primary btn-link btn-sm" onclick="worklist(${emp.empno});">
  ...
  <script>
    function detail(empno){
      	$(location).attr("href", "${path}/team.do?method=teamWorkGrant&empno="+empno);
     }
    function worklist(empno){
    	$(location).attr("href", "${path}/team.do?method=workList&empno="+empno);
    }
