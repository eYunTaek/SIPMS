...
<link href="${path }/material-dashboard-master/assets/demo/demo.css"
	rel="stylesheet" />
<link
	href='${path }/material-dashboard-master/assets/css/cal_core_main.css'
	rel='stylesheet' />
<link
	href='${path }/material-dashboard-master/assets/css/cal_daygrid_main.css'
	rel='stylesheet' />
<link
	href='${path }/material-dashboard-master/assets/css/cal_timegrid_main.css'
	rel='stylesheet' />
<link
	href='${path }/material-dashboard-master/assets/css/fontawesome_all.css'
	rel='stylesheet' />
<link
	href='${path }/material-dashboard-master/assets/css/list_main.min.css'
	rel='stylesheet' />
</head>
<style type="text/css">
body {
...
<body>
    ...
    -->
			<div class="logo">
				<a href="${path }/main.do?method=main"
					class="simple-text logo-normal"> 사원 </a>
			</div>
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="nav-item active"><a class="nav-link"
						href="${path }/main.do?method=main"> <i class="material-icons">dashboard</i>
							<p>사원 페이지</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="${path }/main.do?method=empInfo"> <i
							class="material-icons">person</i>
							<p>내 정보</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="${path }/main.do?method=empteaminfo"> <i
							class="material-icons">group</i>
							<p>팀원 정보</p>
					</a></li>
					<li class="nav-item "><a class="nav-link"
						href="${path }/team.do?method=empPrj"> <i
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="#pablo">사원 페이지</a>
					</div>
							...
							<li class="nav-item dropdown"><a class="nav-link"
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item"
										href="${path }/main.do?method=messageList"><i
										class="material-icons">mail</i>&nbsp;&nbsp;메세지 함</a>
								</div></li>
							<li class="nav-item dropdown"><a class="nav-link"
				...
				<div class="container-fluid">
					<div class="row">
											...
											<h3 class="card-title">
												<div class="progress">
													<div
														...
														id="caldte" onclick="calDate('${myprj1.eddte}');"
														role="progressbar" aria-valuemin="0" aria-valuemax="100"
														style="width: ${showPercent.showPercent}%;"></div>
												</div>
											</h3>
										</div>
									...
									<div class="card card-stats">
										<div class="card-header card-header-warning card-header-icon">
											...
											<h3 class="card-title" style="font-weight:bold;">
												<fmt:formatNumber pattern=",000" value="${myprj1.cost}" />
											</h3>
										</div>
										<div class="card-footer">
											<div class="stats">
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									<div class="card card-stats">
										<div class="card-header card-header-danger card-header-icon">
											...
											<h3 class="card-title" style="font-weight:bold;" id="prjDday"></h3>
										</div>
										<div class="card-footer">
											<div class="stats">
												<i class="material-icons text-danger">warning</i> <a
													href="#pablo">프로젝트 마감일 : ${myprj1.eddte }</a>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card card-stats">
										<div class="card-header card-header-primary card-header-icon">
											...
											<p class="card-category"
												style="color: red; font-weight: bold;">프로젝트가 없습니다</p>
											<br>
										</div>
										<div class="card-footer">
											<div class="stats">
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="card card-stats">
								<c:choose>
									<c:when test="${myprj2 != null }">
										<div
											class="card-header card-header-Secondary card-header-icon">
											<div class="card-icon">
												<i class="material-icons">person</i>
											</div>
											<p class="card-category">MY WORK D-DAY</p>
											<p class="card-category"
												style="color: red; font-weight: bold;">${myprj2.winfo }</p>
											<h3 class="card-title" id="myworkDday" style="font-weight: bold;"></h3>
										</div>
										<div class="card-footer">
											<div class="stats">
												<i class="material-icons text-danger">warning</i> <a
													href="#pablo">개인업무 마감일 : ${myprj2.eddte }</a> <input
													type="hidden" id="eddte2" value="${myprj2.eddte }" />
											</div>
										</div>
									</c:when>
									<c:otherwise>
										<div
											...
											<p class="card-category">MY WORK D-DAY</p>
											<p class="card-category"
												style="color: red; font-weight: bold;">업무가 없습니다</p>
										</div>
										<div class="card-footer">
											<div class="stats">
												<i class="material-icons text-danger">warning</i> <a
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<div class="mt-4 card-footer">
										<span class="stats"> <i class="material-icons">attach_money</i>단위
											: 만원
										</span>
									</div>
								</div>
	...
	<!--   Core JS Files   -->
	<script
		src='${path }/material-dashboard-master/assets/js/cal_core_main.js'></script>
	<script
		src='${path }/material-dashboard-master/assets/js/cal_daygrid_main.js'></script>
	<script
		src='${path }/material-dashboard-master/assets/js/cal_interaction_main.js'></script>
	<script
		src='${path }/material-dashboard-master/assets/js/cal_timegrid_main.js'></script>
	<script
		src='${path }/material-dashboard-master/assets/js/bootstrap_main.min.js'></script>
	<script
		src='${path }/material-dashboard-master/assets/js/list_main.min.js'></script>
	...
	<script>
							...
							$("#teamMember")
									.click(
											function() {
												$(location)
														.attr("href",
																"${path }/main.do?method=empteaminfo");
											});
		...
		var calendar = new FullCalendar.Calendar(calendarEl, {
			...
			eventClick : function(info, element) {
				...
				var stdte = info.event.start.getFullYear() + "-" + smonth + "-"
						+ sday;
				var eddte = info.event.end.getFullYear() + "-" + emonth + "-"
						+ eday;
