...
<body class="">
          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">${tno}팀의 팀원 목록</h4>
               </div>
              <div class="card-body">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">${tno}팀에 추가할 사원 목록</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      ...
                      <thead class=" text-primary">
                      	<tr>
                      	  <th>사원번호</th><th>이름</th><th>직급</th><th>급여</th><th>프로젝트</th><th>추가</th>
                      	</tr>
                      </thead>
                      <tbody>
                      	<c:forEach var="emp" items="${addList}">
                        <tr>
                          <td>${emp.empno}</td>
                          <td>${emp.ename}</td>
                          <td>${emp.posi}</td>
                          ...
                          <td>${emp.pjdo}</td>
                          <td class="td-actions">
                          	<button type="button" class="btn btn-primary btn-link btn-sm" onclick="addTeam(${tno}, ${emp.empno});">
                  ...
                  <div align="center">
                  	<input type="button" class="btn btn-primary" value="목록" onclick="backpg();" />
                  </div>
                </div>
              </div>
           </div>
  ...
  <script>
  	// 팀원 추가
  	function addTeam(tno, empno){
  		$(location).attr("href", "${path}/team.do?method=addMem2&tno="+tno+"&empno="+empno);
  	}
  	// 목록
  	function backpg(){
  		$(location).attr("href", "${path}/team.do?method=tlist");
  	}
