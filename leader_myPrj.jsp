      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">내 프로젝트</a>
          </div>
										...
										<tbody>
											<tr id="prj01">
												...
												<td><div class="progress">
								                  	<div class="progress-bar progress-bar-striped progress-bar-animated" id="caldte" onclick="calDate('${myprj.eddte}');" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: ${showPercent.showPercent}%;">
  ...
  function calDate(input){
    ...
    $(document).ready(function() {
    	$("#prj01").dblclick(function(){
			$(location).attr("href","${path}/main.do?method=leaderWork");
		})
      $().ready(function() {
        $sidebar = $('.sidebar');
