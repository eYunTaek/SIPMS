...
<body class="">
            ...
            <div class="col-md-8" style="margin:auto;">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">개인 업무 부여</h4>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">프로젝트 번호</label>
                          <input type="hidden" id="empno" name="empno"/>
                          <input type="text" class="form-control" name="pjno" value="${work.pjno}" readonly />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">프로젝트 명</label>
                          <input type="text" class="form-control" value="${work.pjtitle}" readonly/>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">진행 단계</label>
                          <input type="number" class="form-control" name="stage" value=""/>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">업무</label>
                          <input type="text" class="form-control" name="winfo" value="" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label">마감일</label><br>
                          <input type="date" class="form-control" name="eddte" value="" />
                        </div>
                      </div>
                    </div>
                    <div align="center">
	                    <input type="button" class="btn btn-primary" value="부여" id="workBtn" />
  ...
  $(document).ready(function() {
	  ...
	  $("#workBtn").click(function(){
			$("#empno").val(<%=empno%>);
			$("form").attr("action","${path}/team.do?method=workGrant");
			$("form").submit();
		});
  	$("#back").click(function(){
