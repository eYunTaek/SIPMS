    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active " data-color="danger">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">내 업무</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
								<div class="card-header card-header-warning">
									<h4 class="card-title">업무 파일</h4>
									<p class="card-category">받은 업무정보를 보여줍니다</p>
								</div>
								<div class="card-body table-responsive">
									<table class="table table-hover">
										<col width="10%"/><col width="10%"/><col width="10%"/><col width="10%"/><col width="10%"/><col width="10%"/><col width="10%"/><col width="18%"/><col width="10%"/>
										...
										<tbody>
											<c:forEach var="myprj" items="${myprj}">
							                     ...
							                     <input type="hidden"  name="wno" value="${myprj.wno}"/>
							                   	</form>
						                    </c:forEach>
										</tbody>
									</table>
