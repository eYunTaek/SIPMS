...
<body class="">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form method="post"class="navbar-form">
              <div class="no-border">
              	<input type="text" class="form-control" name="tno" value="${sch.tno}" placeholder="팀번호" />
                <input type="text" class="form-control" name="pjtitle" value="${sch.pjtitle}" placeholder="프로젝트명" />
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-striped">
                      ...
                      <thead class="text-primary">
                      	<tr>
                      	  <th>팀</th><th>프로젝트명</th><th>파견지역</th><th>시작일</th><th>마감일</th><th>진행률(%)</th>
                      	</tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          <td>
                          	${tl.tno}
                          	<button type="button" rel="tooltip" title="팀 정보" class="btn btn-primary btn-link btn-sm" onclick="teamDetail(${tl.tno})">
	                        	<i class="material-icons">help_outline</i>
	                      	</button>
                          </td>
                          <td>
                          	${tl.pjtitle}
                          	<button type="button" rel="tooltip" title="프로젝트 정보" class="btn btn-primary btn-link btn-sm" onclick="prjDetail(${tl.pjno});">
                          		<i class="material-icons">help_outline</i>
                          	</button>
                          </td>
                          <td>${tl.area}</td>
                          ...
                          <td>
	                          <div class="progress">
									<div class="progress-bar progress-bar-striped progress-bar-animated" onclick="calDate('${tl.eddte}',${tl.pjno });" role="progressbar" id="${tl.pjno }" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: ${tl.showPercent}%;">
										<span>${tl.showPercent }</span>
									</div>
							  </div>
						  </td>
                        </tr>
  ...
  <script>
    // 프로젝트 정보
  	function prjDetail(pjno){
		$(location).attr("href", "${path}/prj.do?method=detail&pjno="+pjno);
	}
    // 팀 정보
