...
<body class="">
  <div class="wrapper ">
            ...
            <div class="col-md-8" style="margin:auto;">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">프로젝트 추가</h4>
                </div>
                <div class="card-body">
                  <form action="${path}/prj.do?method=insert" method="post" onsubmit="return checkForm();">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">팀</label>
                          <select name="tno" id="tno" class="form-control">
                          <c:forEach var="tno" items="${tnlist }">
                          <option value="${tno.tno }">${tno.tno }번 팀</option>
                          </c:forEach>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="pjtitle" id="pjtitle" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>시작일</label>
                          <input type="date" class="form-control" name="stdte" id="stdte" />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>마감일</label>
                          <input type="date" class="form-control" name="eddte" id="eddte" />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="stage" id="stage" value="1" readonly />
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">전체단계</label>
                          <input type="number" class="form-control" name="allstage" id="allstage" value="1" />
                        </div>
                      </div>
                    </div>
                    <div align="center">
                    	<input type="submit" class="btn btn-primary" value="등록" />
                    	<input type="button" class="btn btn-primary" value="취소" id="back" />
                    </div>
    ...
    <input type="hidden" id="isEnd" name="isEnd" value="${fail }"/>
  </div>
  <!--   Core JS Files   -->
  ...
  <script>
  	...
  	function checkForm(){
		...
		if($("#allstage").val()=="" || $("#allstage").val()<1){
			alert("전체단계를 다시 입력하세요.");
			$("#allstage").focus();
			return false;
		}
