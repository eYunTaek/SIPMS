...
<body class="">
                    ...
                    <table class="table">
                     <col width="20%"><col width="20%"><col width="20%"><col width="20%"><col width="20%">
                      <thead class=" text-warning">
                      	<tr>
                      	  <th>업무 번호</th><th>업무 단계</th><th>업무 정보</th><th>파일명</th><th>제출일</th>
                      	</tr>
                      </thead>
                        <tr>
                          <td>${file.wno }</td>
  ...
  function file_manage(wno){
	  $(location).attr("href","${path}/team.do?method=file_manage&wno="+wno);
  }
